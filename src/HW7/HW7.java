...
public class HW7 {
     ...
     */
        public static char[] make_array (String s){
            ...
            for(int i = 0; i < s.length(); i++){
                aoc[i]= s.charAt(i);
                //System.out.print(aoc[s.charAt(i) - 'a'] + ",");
            }
            System.out.println(Arrays.toString(aoc));
     ...
     */
        public static int numDifferent ( int[] nums){
            // int count = 1 since it is going to count the first number regardless of it being duplicate or not.
            int count = 1;
